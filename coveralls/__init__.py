...
def parse_args():
    ...
    try:
        ...
        pass
    yml = yml or {}
    args.repo_token = os.environ.get('COVERALLS_REPO_TOKEN') or yml.get('repo_token', '')
    args.service_name = os.environ.get('COVERALLS_SERVICE_NAME') or yml.get('service_name', 'travis-ci')
